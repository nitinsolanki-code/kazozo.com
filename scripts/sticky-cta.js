...
(function () {
  ...
  ready(function () {
    ...
    if (!document.getElementById('kz-sticky-cta-css')) {
      var css = '\n' +
        '.kz-sticky-cta{position:fixed;left:20px;bottom:24px;z-index:997;transform:translateY(120%);opacity:0;transition:transform .35s ease, opacity .35s ease;pointer-events:none;}\n' +
        ...
        '@media (max-width: 600px){.kz-sticky-cta{right:auto;left:12px;bottom:12px;max-width:calc(100vw - 90px);}.kz-sticky-cta a{justify-content:center;padding:12px 16px;font-size:13px;}}\n' +
